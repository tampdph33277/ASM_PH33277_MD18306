...
import tampdph33277.fpoly.asm_application.Student_API;
...
public class Student_Adapter extends RecyclerView.Adapter<Student_Adapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        holder.tvTenStudent.setText("Mã Sinh Viên: " + student_dto.getStudentId());
        ...
        holder.imgEditStudent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editTextStudentId.setText(student_dto.getStudentId());
                editTextStudentDtb.setText(String.valueOf(student_dto.getAverageScore()));
                Picasso.get().load(student_dto.getAvatar()).into(img_avatar_edit);
   ...
   if (diem >= 0 && diem <= 10) {
                                ...
                                Retrofit retrofit = new Retrofit.Builder()
                                        .baseUrl("http://10.24.26.93:3027/") // Địa chỉ URL cơ sở của máy chủ
